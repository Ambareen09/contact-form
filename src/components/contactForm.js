...
export default function ContactUs() {
    ...
    emailjs.sendForm('service_njjjdac', 'template_fksb30c', e.target, 'user_SH0MzJiYXl8J6fCghbKpa')
        .then((result) => {
            ...
            <form onSubmit={sendEmail}>
                    <div className="row pt-5 mx-auto">
                        ...
                        <div className="col-8 form-group pt-2 mx-auto">
                            <input required type="email" className="form-control" placeholder="Email Address" name="email"/>
                        </div>
                        <div className="col-8 form-group pt-2 mx-auto">
                        ...
                        <div className="col-8 pt-3 mx-auto">
                            <input required type="submit" className="btn btn-info" value="Send Message"></input>
                        </div>
                    </div>
                </form>
            </div>
